...
export const Header = () => {
  ...
  return (
    <div className='h-[128px] w-full'>
      <header className='container fixed left-0 right-0 z-20 mx-auto p-5'>
        <div className='relative flex items-center justify-between rounded-xl border border-primary/30 bg-muted/50 p-5 backdrop-blur-md'>
          <Logo />
